...
const {test,registerUser,loginUser,getProfile,logoutUser,homepagedata,teamData,weather1,eventdata,
  ...
  fall,winter,spring,autumn,blue,green,red,yellow,purple,orange} = require('../controllers/authController')
// middleware
...
router.get('/recomendations/Red-Outfit-Inspiration',red)
router.get('/recomendations/Yellow-Outfit-Inspiration',yellow)
router.get('/recomendations/Purple-Outfit-Inspiration',purple)
router.get('/recomendations/Orange-Outfit-Inspiration',orange)
